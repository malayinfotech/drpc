...
func (d *drpc) generateEncoding(conf config) {
	...
	case "google.golang.org/protobuf":
		d.P("func (", d.EncodingName(), ") Marshal(msg ", d.Ident("drpc", "Message"), ") ([]byte, error) {")
		d.P("return ", d.Ident("google.golang.org/protobuf/proto", "Marshal"), "(msg.(", d.Ident("google.golang.org/protobuf/proto", "Message"), "))")
		d.P("}")
		d.P()

		d.P("func (", d.EncodingName(), ") MarshalAppend(buf []byte, msg ", d.Ident("drpc", "Message"), ") ([]byte, error) {")
		...
		d.P("func (", d.EncodingName(), ") Unmarshal(buf []byte, msg ", d.Ident("drpc", "Message"), ") error {")
		d.P("return ", d.Ident("google.golang.org/protobuf/proto", "Unmarshal"), "(buf, msg.(", d.Ident("google.golang.org/protobuf/proto", "Message"), "))")
		d.P("}")
		d.P()

		if conf.json {
			d.P("func (", d.EncodingName(), ") JSONMarshal(msg ", d.Ident("drpc", "Message"), ") ([]byte, error) {")
			...
			d.P("func (", d.EncodingName(), ") JSONUnmarshal(buf []byte, msg ", d.Ident("drpc", "Message"), ") error {")
...
func (d *drpc) generateService(service *protogen.Service) {
	...
	d.P("DRPCConn() ", d.Ident("drpc", "Conn"))
	d.P()
	...
	d.P("cc ", d.Ident("drpc", "Conn"))
	d.P("}")
	d.P()

	// Client constructor
	d.P("func New", d.ClientIface(service), "(cc ", d.Ident("drpc", "Conn"), ") ", d.ClientIface(service), " {")
	d.P("return &", d.ClientImpl(service), "{cc}")
	d.P("}")
	d.P()

	// Client method implementations
	d.P("func (c *", d.ClientImpl(service), ") DRPCConn() ", d.Ident("drpc", "Conn"), "{ return c.cc }")
	d.P()
	for _, method := range service.Methods {
	...
	d.P()
	d.P("func (", d.ServerDesc(service), ") Method(n int) (string, ", d.Ident("drpc", "Encoding"), ", ", d.Ident("drpc", "Receiver"), ", interface{}, bool) {")
	d.P("switch n {")
	...
	// Registration helper
	d.P("func DRPCRegister", service.GoName, "(mux ", d.Ident("drpc", "Mux"), ", impl ", d.ServerIface(service), ") error {")
...
func (d *drpc) generateUnimplementedServerMethod(method *protogen.Method) {
	...
	if !method.Desc.IsStreamingServer() && !method.Desc.IsStreamingClient() {
		d.P("return nil, ", d.Ident("drpc/drpcerr", "WithCode"), "(", d.Ident("errors", "New"), "(\"Unimplemented\"), ", d.Ident("drpc/drpcerr", "Unimplemented"), ")")
	} else {
		d.P("return ", d.Ident("drpc/drpcerr", "WithCode"), "(", d.Ident("errors", "New"), "(\"Unimplemented\"), ", d.Ident("drpc/drpcerr", "Unimplemented"), ")")
	}
	d.P("}")
	d.P()
}
...
func (d *drpc) generateServerReceiver(method *protogen.Method) {
	d.P("func (srv interface{}, ctx context.Context, in1, in2 interface{}) (" + d.Ident("drpc", "Message") + ", error) {")
	if !method.Desc.IsStreamingServer() && !method.Desc.IsStreamingClient() {
	...
	if method.Desc.IsStreamingServer() || method.Desc.IsStreamingClient() {
		d.P("&", d.ServerStreamImpl(method), "{in", n, ".(", d.Ident("drpc", "Stream"), ")},")
	}
	d.P(")")
}
